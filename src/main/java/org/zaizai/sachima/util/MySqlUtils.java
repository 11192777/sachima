...
public class MySqlUtils {
    ...
    public static boolean isKeyword(String name) {
        ...
        if (words == null) {
            words = new HashSet<>();
            Utils.loadFromFile("parser/mysql/keyword", words);
            keywords = words;
        }
    ...
    public static boolean isBuiltinDataType(String dataType) {
        ...
        String tableLower = dataType.toLowerCase();

        Set<String> dataTypes = builtinDataTypes;

        if (dataTypes == null) {
            dataTypes = new HashSet<>();
            Utils.loadFromFile("parser/mysql/builtin_datatype", dataTypes);
            builtinDataTypes = dataTypes;
        }

        return dataTypes.contains(tableLower);
    }
    ...
    private static final BigDecimal[] MAX_DEC_1 = {
            new BigDecimal("0.9"),
            new BigDecimal("9.9"),
            new BigDecimal("99.9"),
    ...
    private static final BigDecimal[] MIN_DEC_1 = {
            new BigDecimal("-0.9"),
            new BigDecimal("-9.9"),
            new BigDecimal("-99.9"),
            new BigDecimal("-999.9"),
    ...
    private static final BigDecimal[] MAX_DEC_2 = {
            new BigDecimal("0.99"),
            new BigDecimal("9.99"),
    ...
    private static final BigDecimal[] MIN_DEC_2 = {
            new BigDecimal("-0.99"),
            new BigDecimal("-9.99"),
            new BigDecimal("-99.99"),
            new BigDecimal("-999.99"),
