...
public class Keywords {
    ...
    static {
        ...
        Map<String, Token> dmMap = new HashMap<>(Keywords.DEFAULT_KEYWORDS.getKeywords());
        dmMap.put("MERGE", Token.MERGE);
        dmMap.put("MATCHED", Token.MATCHED);
        dmMap.put("USING", Token.USING);
        DM_KEYWORDS = new Keywords(dmMap);
    }
