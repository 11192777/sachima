...
public class Schema {
    ...
    private         String                  name;
    protected final Map<Long, SchemaObject> objects    = new ConcurrentHashMap<>(16, 0.75f, 1);
    protected final Map<Long, SchemaObject> functions  = new ConcurrentHashMap<>(16, 0.75f, 1);
